...
/**
 * swap_ints - interchange 2 int in an array.
 * @a: 1st int to swap.
 * @b: 2nd int to swap.
 */
...
/**
 * bitonic_merge -arrange bitonic sequence in array of int
 * @array: int array
 * @size: array size
...
/**
 * bitonic_seq -cConverts array of int to bitonic sequence.
 * @array: int array.
 * @size: array size.
...
/**
 * bitonic_sort - orders/sorts an int array in asc order 
 * with bitonic sorting algorithm.
 * @array: int array.
 * @size: array size.
 *
 * Description: prints array after each swap. works for
