 ...
 * 0 if s1 == s2, -ve byte difference if s1 < s2
 */
...
/**
 * get_value - get number val of a card.
 * @card: pointer to deck_node_t card.
 *
 * Return: number val of card.
 */
...
/**
 * insertion_sort_deck_value - arranges(sorts) deck of cards sorted 
 * from (spades-diamonds),(ace-king)
 * @deck: pointer to head of deck_node_t doubly linked list.
 */
...
/**
 * sort_deck - arrange(sort) deck of cards 
 * from (ace-king)& from (spades-diamonds)
 * @deck: pointer to head of deck_node_t doubly-linked list.
 */
